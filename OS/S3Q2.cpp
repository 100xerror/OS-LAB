...
/*Implement the First Fit memory allocation algorithm. Input memory block sizes and process sizes. 
For given memory blocks (100, 500, 200, 300, 600) and process sizes (212, 417, 112, 426), determine the allocation and calculate total fragmentation.
*/
