...
/*Write a program to implement the Shortest Job First (SJF) scheduling algorithm. 
Allow the user to input the number of processes and their burst times. Display the average waiting time and turnaround time.
*/
